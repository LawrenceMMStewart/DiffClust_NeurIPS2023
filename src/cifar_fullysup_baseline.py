...
Used as a baseline to compare performance on clustering
+ down stream transfer learning.
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
                    prog='Baseline Model CIFAR 10 supervised',
                    description='Train ResNET 50 on CIFAR 10 with CE loss, fully supervised')
